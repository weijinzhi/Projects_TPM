...
<body>
   ...
   <div id="cc" class="easyui-layout" fit=true style="width:100%;height:100%;">
		    ...
		    <div id="accor" class="easyui-accordion" style="width:200px;">
		    	<div title="部门管理" style="overflow:auto;padding:0px;">
		    		<ul>
		    			<li><a title="to-sec-list"  style="color:black; font-family:华文新魏;font-size:20px;">部门</a></li>
		    			<li><a title="to-pos-list" style="color:black;font-family:华文新魏;font-size:20px;">职位</a></li>
		    		</ul>
		    	</div>
		    	
		    	<div title="员工管理">
		    		<ul>
		    			<li><a title="to-emp-list.action" style="color:black;font-family:华文新魏;font-size:20px;">员工管理</a></li>
		    		</ul>
		    	</div>
		    	
		    	<div title="工资管理">
		    		<ul>
		    			<li><a title="to-sal-list.action" style="color:black;font-family:华文新魏;font-size:20px;">工资管理</a></li>
		    		</ul>
		    	</div>
		    	
		    	<div title="考勤管理">
		    		<ul>
		    			<li><a title="to-she-list.action" style="color:black;font-family:华文新魏;font-size:20px;">考勤管理</a></li>
		    		</ul>
		    	</div>
		    	
		    	<div title="人事变更管理">
		    		<ul>
		    			<li><a title="to-per-list.action" style="color:black;font-family:华文新魏;font-size:20px;">人事变更管理</a></li>
		    		</ul>
		    	</div>
		    	
		    	<div title="权限管理">
		    		<ul>
		    			<li><a title="to-command" style="color:black;font-family:华文新魏;font-size:20px;">权限管理</a></li>
		    		</ul>
		    	</div>
		    	<div title="数据管理">
		    		<ul>
		    			<li><a title="to-authority" style="color:black;font-family:华文新魏;font-size:20px;">数据备份</a></li>
						<li><a title="to-recover" style="color:black;font-family:华文新魏;font-size:20px;">数据恢复</a></li>
		    		</ul>
		    	</div>
		    </div>
		    </div>
