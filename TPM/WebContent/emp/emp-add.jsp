...
<%@page import="com.tpms.entities.Employee"%>
		...
		<form id="test" action="emp-save" method="get">
			<fieldset>
				...
				<div class="form-row">
					...
					<div class="field-widget">
						<input name="name" id="field1" class="required" value="<%=emp.getName()%>"
				...
				<div class="form-row">
					...
					<div class="field-widget" >
						<input type="radio" class="radio_input" name="sex" id="s1" checked=""
							value="1" />男 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
				...
				<div class="form-row">
					...
					<div class="field-widget">
						<input name="age" id="age" class="required" value="<%=emp.getAge() %>" />
					</div>
				</div>
				...
				<div class="form-row">
					...
					<div class="field-widget">
						<input name="address" id="address" class="required" value="<%=emp.getAddress() %>" />
					</div>
				</div>
				...
				<div class="form-row">
					...
					<div class="field-widget">
						<input name="phone" id="phone" class="required" value="<%=emp.getPhone() %>" />
					</div>
				</div>
				...
				<div class="form-row">
					...
					<div class="field-widget">
						<input name="email" id="email" class="required" value="<%=emp.getEmail() %>" />
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="field-widget">
						<input type="text" name="birth" class="easyui-datebox" value="<%=emp.getBirth() %>" />
					</div>
				</div>
				...
				<div class="form-row">
					...
					<div class="field-widget">
						<input name="height" id="email" class="required" value="<%=emp.getHeight() %>" />
					</div>
				</div>
			...
			<fieldset>
				...
				<div class="form-row">
					...
					<div class="field-widget">
						<input name="polity" id="idcard" class="required" value="<%=emp.getPolity() %>" />
					</div>
				</div>
				...
				<div class="form-row">
					...
					<div class="field-widget">
						<input name="idcard" id="idcard" class="required" value="<%=emp.getIdcard() %>" />
					</div>
				</div>
				...
				<div class="form-row">
					...
					<div class="field-widget">
						<input name="account" id="account" class="required" value="<%=emp.getAccount() %>" />
					</div>
				</div>
				...
				<div class="form-row">
					...
					<div class="field-widget">
						<input name="bank_name" id="account"
							class="required" value="<%=emp.getBank_name() %>" />
					</div>
				</div>
				...
				<div class="form-row">
					...
					<div class="field-widget">
						<input name="arrival" id="arrival" class="easyui-datebox" value="<%=emp.getArrival() %>" />
					</div>
				</div>
				...
				<div class="form-row">
					...
					<div class="field-widget">
						<input name="password" id="password"
							class="required" value="<%=emp.getPassword() %>" />
					</div>
				</div>
